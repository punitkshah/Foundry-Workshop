...
- Ensure maintenance and dispatch release remain valid before departure.

## Crew Coordination

- Check crew duty limits whenever a delay exceeds one hour.
- Engage crew scheduling early if there is risk of legality issues.
- Record any crew substitutions in the operational log.
...
- Document the recovery plan, revised departure estimate, and owner for each action.
